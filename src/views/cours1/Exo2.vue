<template>
  <div>
    ...
    <h3> Exercice 2 : </h3>
    <p> Créez un deuxième composant qui affiche les id-card en liste. En haut de la liste, créez un bouton qui permet de trier les cards par date de naissance. </p>
